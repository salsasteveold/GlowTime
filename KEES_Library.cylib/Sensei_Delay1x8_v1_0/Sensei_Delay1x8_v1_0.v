...
// ========================================
/*******************************************************************************
* File Name: Sensei_Delay1x8_v1_0.v
* Version `$CY_MAJOR_VERSION`.`$CY_MINOR_VERSION`
*
* Description:
* This component delays the input 8-bit bus by one clock cycle.  This is the 
* exact same function as an 8-bit wide D Flip-Flop.  The only difference is
* that this component uses the datapath to implement the storage.
*
********************************************************************************
* Data Path register definitions
********************************************************************************
* Datapath: DelayDP
* DESCRIPTION: Used to implement the 8-bit register
* REGISTER USAGE:
* F0 => not used
* F1 => not used
* D0 => not used
...
*    do1[7:0]          output          8-bit registered data output
*
********************************************************************************/
`include "cypress.v"
`ifdef Sensei_Delay1x8_v1_0_V_ALREADY_INCLUDED
`else
`define Sensei_Delay1x8_v1_0_V_ALREADY_INCLUDED

//`#end` -- edit above this line, do not edit this line
// Generated on 03/02/2011 at 23:44
// Component: Sensei_Delay1x8_v1_0
module Sensei_Delay1x8_v1_0 (
	do1,
	clk,
	di,
	en,
...
//`#start body` -- edit after this line, do not edit this line
    ...
    ***************************************************************************/   
	wire [2:0] cs_addr = {1'b0, reset, en};
    ...
    ***************************************************************************/   
	cy_psoc3_dp #(.cy_dpconfig(
	{
		...
		`CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
		`CS_CMP_SEL_CFGA, /*CFGRAM1: Enabled*/
		`CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
		...
		`SC_WRK16CAT_DSBL /*CFG17-16: */
			...
			/* output [07:00]           */  .po(do1)       // Parallel data port
	);
//`#end` -- edit above this line, do not edit this line
endmodule
//`#start footer` -- edit after this line, do not edit this line
`endif /* Sensei_Delay1x8_v1_0_V_ALREADY_INCLUDED */
//`#end` -- edit above this line, do not edit this line
